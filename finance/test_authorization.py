...
class FinanceAuthorizationTests(TenantTestCase):
    ...
    def setUp(self):
        ...
        self.own_student = Student.objects.create(user=self.student_user, first_name='Own', last_name='Student', admission_number='AUTH-STD-1', parent_guardian=parent, parent_contact=parent.phone_number, classroom=classroom)
        self.other_student = Student.objects.create(first_name='Other', last_name='Student', admission_number='AUTH-STD-2', parent_contact='08000000103', classroom=classroom)
