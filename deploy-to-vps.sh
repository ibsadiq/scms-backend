...
if [ "$SKIP_FRONTEND" = false ]; then
    ...
    echo "  • Admin:     http://72.61.184.120/admin/ (Frontend Admin)"
    echo "  • Django:    http://72.61.184.120/django-admin/ (Django Admin Panel)"
    ...
    echo "  • Django:    http://72.61.184.120:8000/django-admin/ (Django Admin Panel)"
    echo "  • Flower:    http://72.61.184.120:5555/"
    echo ""
