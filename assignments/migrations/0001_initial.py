    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submission_text",
                    models.TextField(
                        blank=True, help_text="Text submission (optional)"
                    ),
                ),
                ...
                (
                    "is_late",
                    models.BooleanField(
                        default=False, help_text="Submitted after due date"
                    ),
                ),
                (
                    "assignment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback",
                    models.TextField(blank=True, help_text="Teacher feedback/comments"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["classroom", "status", "-due_date"],
                name="assignments_classro_e8f971_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignment",
            index=models.Index(
                fields=["teacher", "-assigned_date"],
                name="assignments_teacher_86c1ef_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentsubmission",
            index=models.Index(
                fields=["assignment", "student"], name="assignments_assignm_e2e7ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assignmentsubmission",
            index=models.Index(
                ...
                name="assignments_student_01ede3_idx",
            ),
        ),
