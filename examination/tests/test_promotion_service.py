...
class PromotionServiceTestCase(TestCase):
    ...
    def test_promotion_override(self):
        ...
        AssessmentEntry.objects.create(student=self.enrollment, term=self.term1, subject=self.subject, component=self.ca_component, score=5, entered_by=self.teacher)
        AssessmentEntry.objects.create(student=self.enrollment, term=self.term1, subject=self.subject, component=self.exam_component, score=15, entered_by=self.teacher)
