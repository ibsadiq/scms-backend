...
class BehavioralRatingViewSet(viewsets.ViewSet):
    ...
    def retrieve_ratings(self, request, term_result_id=None):
        term_result = get_object_or_404(TermResult.objects.select_related('student', 'classroom', 'classroom__grade_level'), pk=term_result_id)
    ...
    def bulk_record(self, request):
        ...
        term_result_id = serializer.validated_data['term_result']
