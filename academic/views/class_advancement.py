...
from academic.models import StudentClassEnrollment, Student
...
from academic.services import ClassAdvancementService
...
class ClassAdvancementViewSet(viewsets.ViewSet):
    ...
    serializer_class = ClassMovementPreviewSerializer
...
class StreamAssignmentViewSet(viewsets.ViewSet):
    ...
    serializer_class = StreamAssignmentSerializer
