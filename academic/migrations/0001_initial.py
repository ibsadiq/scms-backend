    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_rank', models.IntegerField(blank=True, help_text='Rank for subject reports', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prems_number', models.CharField(blank=True, max_length=50)),
                ('std_vii_number', models.CharField(blank=True, max_length=50)),
